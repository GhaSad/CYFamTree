...
public class LienMainTest {
    public static void main(String[] args) {
        ...
        Utilisateur alice = new Utilisateur("Alice", "Durand", LocalDate.of(1990, 1, 1), Nationalite.FRANCAIS, 34, true, true);
        Utilisateur bob = new Utilisateur("Bob", "Martin", LocalDate.of(1995, 1, 1), Nationalite.FRANCAIS, 29, true, true);
